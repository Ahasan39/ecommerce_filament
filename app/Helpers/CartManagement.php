...
{
    // reset cart (alias for clearCartItems)
    ...
    // calculate grand total price only
    static public function calculateGrandTotal($items)
    {
        return array_sum(array_column($items, 'total_amount'));
    }

    // ✅ New method to calculate subtotal, tax, shipping, and grand total
    static public function calculateFinalTotal($items, $shipping_cost = 100, $tax_rate = 0)
    {
