          ...
          <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
            <div class="border border-gray-300 dark:border-gray-700">
              ...
              <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700">
                ...
                <a wire:click.prevent='addToCart({{ $product->id }})' href="#" class="text-gray-500
                  ...
                  </svg><span wire:loading.remove wire:target='addToCart({{ $product->id }})'>Add to Cart</span> <samp wire:loading 
                  wire:target='addToCart({{ $product->id }})' >Adding...</samp>
                </a>
