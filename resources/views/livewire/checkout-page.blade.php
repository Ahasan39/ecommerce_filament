					...
					<div class="mb-6">
						...
						<div class="mt-4">
							...
							<input
								...
								placeholder="Example: গ্রাম/বাজার/থানা"
			...
			<div class="md:col-span-12 lg:col-span-4 col-span-12">
				<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
					...
					<div class="flex justify-between mb-2 font-bold">
						...
						<span>
							{{ Number::currency($shipping ?? 0, 'BDT') }}
						</span>
					</div>
					...
					<div class="flex justify-between mb-2 font-bold">
						...
						<span>
							{{ Number::currency($grand_total ?? 0, 'BDT') }}
						</span>
					</div>
					</hr>
				</div>
				<button type="submit"
					...
					class="w-full p-4 bg-green-500 mt-4 rounded-lg text-lg text-white hover:bg-green-600 dark:bg-green-500 dark:hover:bg-green-700 flex items-center justify-center gap-2 transition-all duration-300 transform hover:scale-105 hover:shadow-lg active:scale-95"
